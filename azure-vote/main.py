...
logger.addHandler(AzureEventHandler(connection_string='InstrumentationKey=fa5616ac-e333-4cce-bc49-8a5982c47936'))
    ...
    if request.method == 'GET':
       ...
       # if vote1:
        ...
        if request.form['vote'] == 'reset':
            ...
            properties = {'custom_dimensions': {'Reset Votes': 0}}
            tracer.span(name="Reset Votes")
            logger.info('Info Reset Votes', extra=properties)
            ...
            if (vote=='Cats'): 
                ...
                tracer.span(name="Cats Vote")
                logger.info('Info Cats Vote', extra=properties)
            ...
            if (vote=='Dogs'):
                ...
                tracer.span(name="Dogs Vote")
                logger.info('Info Dogs Vote', extra=properties)
